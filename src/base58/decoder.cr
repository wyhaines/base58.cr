...
module Base58
  ...
  @[AlwaysInline]
  def self.decode(value : Pointer(UInt8), size : Int32, into : StaticArray(UInt8, N) | Slice(UInt8), alphabet : Alphabet.class = Alphabet::Bitcoin) forall N
  ...
  def self.decode(value : Pointer(UInt8), size : Int32, into : StringBuffer, alphabet : Alphabet.class = Alphabet::Bitcoin)
    decode_into_string(value, into.buffer, size, alphabet)
  end
  ...
  @[AlwaysInline]
  private def self.decode_into_string(value : Int, string : String, size : Int, alphabet : Alphabet.class = Alphabet::Bitcoin)
    decode_into_pointer(value, (string.as(UInt8*) + String::HEADER_SIZE), size, alphabet)
  ...
  @[AlwaysInline]
  private def self.decode_into_string(value : Pointer(UInt8), string : String, size : Int, alphabet : Alphabet.class = Alphabet::Bitcoin)
    _, final_size = decode_into_pointer(value, (string.as(UInt8*) + String::HEADER_SIZE), size, alphabet)
    header = string.as({Int32, Int32, Int32}*)
    header.value = {String::TYPE_ID, final_size, final_size}
    string
  end
