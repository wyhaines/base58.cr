...
module Base58
  ...
  #
  # TODO: Some of these overloads are implemented expediently, but there are places where extra memory
  # copying is done, and so there is room for improvement with regard to performance and efficiency.
  module SS58
